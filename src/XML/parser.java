...
***********/
	public static void main(String args[]) throws Exception {
		...
		parser parser_obj;
		if (args.length==0) 
			parser_obj=new parser(new Scanner(new java.io.FileInputStream("ejemplo_fuente/fibonacci.tny"),sf),sf);
		else 
			parser_obj=new parser(new Scanner(new java.io.FileInputStream("ejemplo_fuente/fibonacci.tny"),sf),sf);
		...
		ts.cargarTabla(root);
		ts.ImprimirClaves();
		XML.Generador.setTablaSimbolos(ts);
		XML.Generador.generarCodigoObjeto(root);
	}
