...
public class Generador {
	...
	public static void generarCodigoObjeto(NodoBase raiz){
		System.out.println();
		System.out.println();
		System.out.println("------ CODIGO OBJETO DEL LENGUAJE XML GENERADO PARA LA TM ------");
		System.out.println();
		System.out.println();
		...
		System.out.println();
		System.out.println();
		System.out.println("------ FIN DEL CODIGO OBJETO DEL LENGUAJE XML GENERADO PARA LA TM ------");
	}
	...
	private static void generarPreludioEstandar(){
		UtGen.emitirComentario("Compilacion XML para el codigo objeto TM");
